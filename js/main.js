...
function applyCardVisualSystem() {
  ...
  style.textContent = `
    ...
    [class*="calculator-card"] {
      ...
      filter:
        drop-shadow(0 18px 36px var(--color-shadow))
        drop-shadow(0 0 4px rgba(18, 63, 54, 0.38)) !important;
      -webkit-mask:
        radial-gradient(circle at 0 0, transparent 0 var(--corner-cut), #000 calc(var(--corner-cut) + 1px)) top left / 50.5% 50.5% no-repeat,
        radial-gradient(circle at 100% 0, transparent 0 var(--corner-cut), #000 calc(var(--corner-cut) + 1px)) top right / 50.5% 50.5% no-repeat,
        radial-gradient(circle at 100% 100%, transparent 0 var(--corner-cut), #000 calc(var(--corner-cut) + 1px)) bottom right / 50.5% 50.5% no-repeat,
        radial-gradient(circle at 0 100%, transparent 0 var(--corner-cut), #000 calc(var(--corner-cut) + 1px)) bottom left / 50.5% 50.5% no-repeat !important;
      mask:
        radial-gradient(circle at 0 0, transparent 0 var(--corner-cut), #000 calc(var(--corner-cut) + 1px)) top left / 50.5% 50.5% no-repeat,
        radial-gradient(circle at 100% 0, transparent 0 var(--corner-cut), #000 calc(var(--corner-cut) + 1px)) top right / 50.5% 50.5% no-repeat,
        radial-gradient(circle at 100% 100%, transparent 0 var(--corner-cut), #000 calc(var(--corner-cut) + 1px)) bottom right / 50.5% 50.5% no-repeat,
    ...
    .portfolio-note {
      --card-fill: var(--color-surface-muted);
    }

    .expertise-card-featured {
      filter:
        drop-shadow(0 18px 36px var(--color-shadow))
        drop-shadow(0 0 8px rgba(18, 63, 54, 0.58)) !important;
    }
    ...
    .contact-form::before,
    .contact-form::after,
    .contact-sidebar article::before,
    .contact-sidebar article::after {
